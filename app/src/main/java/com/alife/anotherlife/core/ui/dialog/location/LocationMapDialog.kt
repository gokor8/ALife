...
class LocationMapDialog @Inject constructor(): AbstractDialog(
    R.drawable.ic_dialog_camera,
    TextWrapper.ResWrapper(R.string.dialog_map_location_title),
    TextWrapper.ResWrapper(R.string.dialog_map_location_description)
)