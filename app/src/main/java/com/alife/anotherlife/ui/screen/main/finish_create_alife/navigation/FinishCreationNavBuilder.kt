...
import com.alife.anotherlife.ui.screen.main.finish_create_alife.FinishCreateAlifeScreen
...
class FinishCreationNavBuilder(
    ...
    @Composable
    override fun content(navBackStackEntry: NavBackStackEntry) = FinishCreateAlifeScreen()
}